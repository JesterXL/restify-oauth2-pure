...
const makeSetup = (grantTypes, requiredHooks, grantToken) => {
    // [jwarden 2.3.2018] TODO: ensure the function signature matches as we're changing module.exports
    const errorSenders = require("./makeErrorSenders")(grantTypes);
    const handleAuthenticatedResource = require("./makeHandleAuthenticatedResource")(errorSenders);

    const restifyOAuth2Setup = (server, options) => {
    ...
    return restifyOAuth2Setup;
};

module.exports = makeSetup;