...
const makeSetup = (grantTypes, requiredHooks, grantToken) => {
    const errorSenders = require("./makeErrorSenders").makeErrorSenders(grantTypes);
    const handleAuthenticatedResource = require("./makeHandleAuthenticatedResource").makeHandleAuthenticatedResource(errorSenders);
